...
#### Now, we are going to use what we have learned to predict future values of a time series. For this task, we are going to use a dataset from the package "datasets" called LakeHuron, that has information about the level of Lake Huron from 1875 to 1972
...
pred <- predict(fit, n.ahead = 10) ## We predict the levels of the next 10 years 
...
### CHALLENGE 3: 
#### Predict the number of people that is going to take the plane in the following 3 years using the AirPassengers dataset.
